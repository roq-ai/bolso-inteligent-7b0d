...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['account-owner', 'family-member'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Budget', path: '/budgets', entity: 'budget', service: AccessServiceEnum.PROJECT, icon: FiPieChart },
    { name: 'Expense', path: '/expenses', entity: 'expense', service: AccessServiceEnum.PROJECT, icon: FiShoppingBag },
    { name: 'Income', path: '/incomes', entity: 'income', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
